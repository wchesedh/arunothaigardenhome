  ...
  const handleCancelRental = async () => {
    ...
    try {
      ...
      const { error: membersError } = await supabase
        .from('apartment_tenant_members')
        .delete()
        .eq('apartment_tenant_id', groupToCancel.id);

      if (membersError) {
        console.error('Error deleting rental members:', membersError);
        throw new Error(`Failed to delete rental members: ${membersError.message}`);
      }

      // Then delete the rental group
      ...
      if (groupError) {
        console.error('Error deleting rental group:', groupError);
        throw new Error(`Failed to delete rental group: ${groupError.message}`);
      }
          ...
          <div>
            ...
            {loading ? (
              ...
              <div className="bg-white rounded-lg border p-6 text-center">
                ...
                <p className="text-gray-500">No rental groups for this apartment yet.</p>
              </div>
            ) : (
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="relative">
                          <select
                            ...
                            disabled={updatingStatus === group.id}
                            className={`px-3 py-2 rounded-lg text-sm font-medium appearance-none pr-8 cursor-pointer border
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 z-50 flex items-center justify-center">
          <div className="bg-white rounded-lg p-6 w-[90%] max-w-sm shadow-xl">
            ...
            <p className="text-gray-700 mb-6">
              ...
              This will remove all tenants from this group and delete the rental record.<br />
              This action cannot be undone.
            </p>
            <div className="flex justify-end gap-3">
              <button
